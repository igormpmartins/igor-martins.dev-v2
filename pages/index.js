        ...
        <div className='container mx-auto bg-network'>
                ...
                <div className='grid grid-cols-0 bg-white rounded-lg shadow-lg py-6 mt-5'>
                    {[1].map( i=> {
                        ...
                        <div className='px-12 md:border-dashed md:border-r-2 text-center' key={i}>
                            ...
                            <p className='text-lg md:text-2xl uppercase mb-2'>Information System's</p>
            ...
            <div className='my-8'>
                <p className='text-center border-t-2'>You can find the source-code of this website here:<br />
                    <a href='https://github.com/igormpmartins/igor-martins.dev-v2' className='font-bold text-sm md:text-base'>https://github.com/igormpmartins/igor-martins.dev-v2</a>
                </p>
            </div>
