    ...
    return (
        <div className='md:grid md:grid-cols-2 md:pt-16 leading-none'>
                <div className='pt-8 md:pt-32'>
                    <h1 className='text-2xl md:text-4xl uppercase text-center md:text-left md:pl-16'>Igor Martins</h1>
                    <h2 className='font-bold text-3xl md:text-5xl text-center md:text-left uppercase md:pl-16'>Fullstack Developer</h2>
